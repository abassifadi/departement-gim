...
<div class="page-header">
  <h4>Liste Des Critere Examinateur</h4>
</div>
<br/>
...
<table class="table  table-striped table-condensed" id="table">
  ...
  <tbody>
    @foreach($criteres as $critere)
       ...
       <td>
         {!! Form::open(array('route' => array('adminPPP.post.examinateur.delete'), 'method' => 'post' , 'class'=> 'form-delete')) !!}
       ...
       <td>
    <a href="{{ route('AdminPPP.update.examinateur.critere',$critere->id) }}" class="btn " > Update</a>
  </td>
